const { getSubcategoriesByCategory, addCategory, getCategories, deleteCategory, addSubcategory, deleteSubcategory } = require('../Controllers/Category/Category');
...
router.get('/get-subcategories/:categoryId', auth, getSubcategoriesByCategory);
